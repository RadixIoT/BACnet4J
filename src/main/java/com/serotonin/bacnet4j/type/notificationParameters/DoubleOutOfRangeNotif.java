...
public class DoubleOutOfRangeNotif extends AbstractNotificationParameter {
    ...
    public String toString() {
        return "DoubleOutOfRangeNotif[ exceedingValue=" + exceedingValue + ", statusFlags=" + statusFlags + ", deadband=" + deadband + ", exceedingLimit=" + exceedingLimit + ']';
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final DoubleOutOfRangeNotif other = (DoubleOutOfRangeNotif) obj;
        if (deadband == null) {
