...
public class Destination extends BaseType {
    ...
    public String toString() {
        return "Destination [validDays=" + validDays + ", fromTime=" + fromTime + ", toTime=" + toTime + ", recipient=" + recipient + ", processIdentifier=" + processIdentifier + ", issueConfirmedNotifications=" + issueConfirmedNotifications + ", transitions=" + transitions + "]";
    }
}
