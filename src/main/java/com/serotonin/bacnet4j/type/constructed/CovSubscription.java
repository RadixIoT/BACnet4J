...
public class CovSubscription extends BaseType {
    ...
    public String toString() {
        return "CovSubscription [recipient=" + recipient + ", monitoredPropertyReference=" + monitoredPropertyReference + ", issueConfirmedNotifications=" + issueConfirmedNotifications + ", timeRemaining=" + timeRemaining + ", covIncrement=" + covIncrement + "]";
    }
