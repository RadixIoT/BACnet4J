...
public class EventNotificationSubscription extends BaseType {
    ...
    public String toString() {
        return "EventNotificationSubscription [recipient=" + recipient + ", processIdentifier=" + processIdentifier + ", issueConfirmedNotifications=" + issueConfirmedNotifications + ", timeRemaining=" + timeRemaining + "]";
    }
