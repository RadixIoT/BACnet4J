...
public class PropertyAccessResult extends BaseType {
    ...
    public String toString() {
        return "PropertyAccessResult [objectIdentifier=" + objectIdentifier + ", propertyIdentifier=" + propertyIdentifier + ", propertyArrayIndex=" + propertyArrayIndex + ", deviceIdentifier=" + deviceIdentifier + ", result=" + result + "]";
    }
