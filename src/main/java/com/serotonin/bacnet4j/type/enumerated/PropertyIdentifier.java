...
public class PropertyIdentifier extends Enumerated {
    ...
    public static final PropertyIdentifier issueConfirmedNotifications = new PropertyIdentifier(51);
    ...
    public static final PropertyIdentifier maxManager = new PropertyIdentifier(64);
    ...
    public static final PropertyIdentifier autoSubordinateDiscovery = new PropertyIdentifier(169);
    public static final PropertyIdentifier manualSubordinateAddressBinding = new PropertyIdentifier(170);
    public static final PropertyIdentifier subordinateAddressBinding = new PropertyIdentifier(171);
    public static final PropertyIdentifier subordinateProxyEnable = new PropertyIdentifier(172);
    ...
    public static final PropertyIdentifier defaultPresentValue = new PropertyIdentifier(492);
    public static final PropertyIdentifier presentStage = new PropertyIdentifier(493);
    public static final PropertyIdentifier stages = new PropertyIdentifier(494);
    public static final PropertyIdentifier stageNames = new PropertyIdentifier(495);
    public static final PropertyIdentifier targetReferences = new PropertyIdentifier(496);
    public static final PropertyIdentifier auditSourceReporter = new PropertyIdentifier(497);
    public static final PropertyIdentifier auditLevel = new PropertyIdentifier(498);
    public static final PropertyIdentifier auditNotificationRecipient = new PropertyIdentifier(499);
    public static final PropertyIdentifier auditPriorityFilter = new PropertyIdentifier(500);
    public static final PropertyIdentifier auditableOperations = new PropertyIdentifier(501);
    public static final PropertyIdentifier deleteOnForward = new PropertyIdentifier(502);
    public static final PropertyIdentifier maximumSendDelay = new PropertyIdentifier(503);
    public static final PropertyIdentifier monitoredObjects = new PropertyIdentifier(504);
    public static final PropertyIdentifier sendNow = new PropertyIdentifier(505);
    public static final PropertyIdentifier floorNumber = new PropertyIdentifier(506);
    public static final PropertyIdentifier deviceUuid = new PropertyIdentifier(507);
    public static final PropertyIdentifier additionalReferencePorts = new PropertyIdentifier(508);
    public static final PropertyIdentifier certificateSigningRequestFile = new PropertyIdentifier(509);
    public static final PropertyIdentifier commandValidationResult = new PropertyIdentifier(510);
    public static final PropertyIdentifier issuerCertificateFiles = new PropertyIdentifier(511);
    public static final PropertyIdentifier maxBvlcLengthAccepted = new PropertyIdentifier(4194304);
    public static final PropertyIdentifier maxNpduLengthAccepted = new PropertyIdentifier(4194305);
    public static final PropertyIdentifier operationalCertificateFile = new PropertyIdentifier(4194306);
    public static final PropertyIdentifier currentHealth = new PropertyIdentifier(4194307);
    public static final PropertyIdentifier scConnectWaitTimeout = new PropertyIdentifier(4194308);
    public static final PropertyIdentifier scDirectConnectAcceptEnable = new PropertyIdentifier(4194309);
    public static final PropertyIdentifier scDirectConnectAcceptUris = new PropertyIdentifier(4194310);
    public static final PropertyIdentifier scDirectConnectBinding = new PropertyIdentifier(4194311);
    public static final PropertyIdentifier scDirectConnectConnectionStatus = new PropertyIdentifier(4194312);
    public static final PropertyIdentifier scDirectConnectInitiateEnable = new PropertyIdentifier(4194313);
    public static final PropertyIdentifier scDisconnectWaitTimeout = new PropertyIdentifier(4194314);
    public static final PropertyIdentifier scFailedConnectionRequests = new PropertyIdentifier(4194315);
    public static final PropertyIdentifier scFailoverHubConnectionStatus = new PropertyIdentifier(4194316);
    public static final PropertyIdentifier scFailoverHubUri = new PropertyIdentifier(4194317);
    public static final PropertyIdentifier scHubConnectorState = new PropertyIdentifier(4194318);
    public static final PropertyIdentifier scHubFunctionAcceptUris = new PropertyIdentifier(4194319);
    public static final PropertyIdentifier scHubFunctionBinding = new PropertyIdentifier(4194320);
    public static final PropertyIdentifier scHubFunctionConnectionStatus = new PropertyIdentifier(4194321);
    public static final PropertyIdentifier scHubFunctionEnable = new PropertyIdentifier(4194322);
    public static final PropertyIdentifier scHeartbeatTimeout = new PropertyIdentifier(4194323);
    public static final PropertyIdentifier scPrimaryHubConnectionStatus = new PropertyIdentifier(4194324);
    public static final PropertyIdentifier scPrimaryHubUri = new PropertyIdentifier(4194325);
    public static final PropertyIdentifier scMaximumReconnectTime = new PropertyIdentifier(4194326);
    public static final PropertyIdentifier scMinimumReconnectTime = new PropertyIdentifier(4194327);
    public static final PropertyIdentifier colorOverride = new PropertyIdentifier(4194328);
    public static final PropertyIdentifier colorReference = new PropertyIdentifier(4194329);
    public static final PropertyIdentifier defaultColor = new PropertyIdentifier(4194330);
    public static final PropertyIdentifier defaultColorTemperature = new PropertyIdentifier(4194331);
    public static final PropertyIdentifier overrideColorReference = new PropertyIdentifier(4194332);
    public static final PropertyIdentifier writeEveryScheduledAction = new PropertyIdentifier(4194333);
    public static final PropertyIdentifier colorCommand = new PropertyIdentifier(4194334);
    public static final PropertyIdentifier highEndTrim = new PropertyIdentifier(4194335);
    public static final PropertyIdentifier lowEndTrim = new PropertyIdentifier(4194336);
    public static final PropertyIdentifier trimFadeTime = new PropertyIdentifier(4194337);
    public static final PropertyIdentifier deviceAddressProxyEnable = new PropertyIdentifier(4194338);
    public static final PropertyIdentifier deviceAddressProxyTable = new PropertyIdentifier(4194339);
    public static final PropertyIdentifier deviceAddressProxyTimeout = new PropertyIdentifier(4194340);
    public static final PropertyIdentifier defaultOnValue = new PropertyIdentifier(4194341);
    public static final PropertyIdentifier lastOnValue = new PropertyIdentifier(4194342);
    public static final PropertyIdentifier authorizationCache = new PropertyIdentifier(4194343);
    public static final PropertyIdentifier authorizationGroups = new PropertyIdentifier(4194344);
    public static final PropertyIdentifier authorizationPolicy = new PropertyIdentifier(4194345);
    public static final PropertyIdentifier authorizationScope = new PropertyIdentifier(4194346);
    public static final PropertyIdentifier authorizationServer = new PropertyIdentifier(4194347);
    public static final PropertyIdentifier authorizationStatus = new PropertyIdentifier(4194348);
    public static final PropertyIdentifier maxProxiedIAmsPerSecond = new PropertyIdentifier(4194349);
