...
public class AnalogInputObject extends BACnetObject {
    ...
    public AnalogInputObject supportIntrinsicReporting(final int timeDelay, final int notificationClass,
        ...
        // Now add the mixin.
        addMixin(new IntrinsicReportingMixin(this, new OutOfRangeAlgo(), new FaultOutOfRangeAlgo(
                PropertyIdentifier.faultLowLimit, PropertyIdentifier.faultHighLimit, PropertyIdentifier.reliability),
