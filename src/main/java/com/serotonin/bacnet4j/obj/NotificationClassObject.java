...
public class NotificationClassObject extends BACnetObject {
    ...
    public static NotificationClassObject create(final LocalDevice localDevice, final int instanceNumber)
        ...
        return new NotificationClassObject(localDevice, instanceNumber, ObjectType.notificationClass
                .toString() + " " + instanceNumber, 20, 10, 30, new EventTransitionBits(false, false, false))
