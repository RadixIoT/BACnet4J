...
public class CharacterStringObject extends BACnetObject {
     ...
     */
    public CharacterStringObject(LocalDevice localDevice, int instanceNumber, String name,
            final CharacterString presentValue, final boolean outOfService) throws BACnetServiceException {
