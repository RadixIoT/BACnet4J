...
public class ConfirmedPrivateTransferRequest extends ConfirmedRequestService {
    ...
    public AcknowledgementService handle(final LocalDevice localDevice, final Address from) throws BACnetException {
        ...
        if (handler == null) {
            throw new BACnetErrorException(TYPE_ID, new ConfirmedPrivateTransferError(new ErrorClassAndCode(
                    ErrorClass.services, ErrorCode.optionalFunctionalityNotSupported), vendorId, serviceNumber,
                    new CharacterString("No handler for vendorId/serviceNumber")));
        }
