...
public class WritePropertyMultipleRequest extends ConfirmedRequestService {
    ...
    private BACnetErrorException createException(final ErrorClass errorClass, final ErrorCode errorCode,
        ...
        return new BACnetErrorException(getChoiceId(), new WritePropertyMultipleError(new ErrorClassAndCode(errorClass,
                errorCode), new ObjectPropertyReference(spec.getObjectIdentifier(), pvToUse.getPropertyIdentifier(),
    ...
    public int hashCode() {
        final int PRIME = 31;
        int result = 1;
        result = PRIME * result + (listOfWriteAccessSpecifications == null
                ? 0
