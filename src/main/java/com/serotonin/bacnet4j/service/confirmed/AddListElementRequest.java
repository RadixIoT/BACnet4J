...
public class AddListElementRequest extends ConfirmedRequestService {
    ...
    public AcknowledgementService handle(final LocalDevice localDevice, final Address from) throws BACnetException {
        ...
        ObjectPropertyTypeDefinition def = ObjectProperties.getObjectPropertyTypeDefinition(objectIdentifier
                .getObjectType(), propertyIdentifier);
        ...
        final SequenceOf<Encodable> copyList = new SequenceOf<>(new ArrayList<>(((SequenceOf<Encodable>) e)
                .getValues()));
            ...
            if (def != null) {
                ...
                if (list.getCount() > 0) {
                    if (list.getBase1(1).getClass() != pr.getClass()) {
                        throw createException(ErrorClass.property, ErrorCode.invalidDataType, new UnsignedInteger(
                                i + 1));
                    }
                }
            }
    ...
    private BACnetErrorException createException(final ErrorClass errorClass, final ErrorCode errorCode,
        ...
        return new BACnetErrorException(getChoiceId(), new ChangeListError(new ErrorClassAndCode(errorClass, errorCode),
    ...
    AddListElementRequest(final ByteQueue queue) throws BACnetException {
        ...
        try {
            ...
            final ObjectPropertyTypeDefinition def = ObjectProperties.getObjectPropertyTypeDefinition(objectIdentifier
                    .getObjectType(), propertyIdentifier);
            popStart(queue, 3);
