...
public class AtomicReadFileRequest extends ConfirmedRequestService {
    ...
    public AcknowledgementService handle(final LocalDevice localDevice, final Address from) throws BACnetException {
        ...
        try {
            ...
            if (bsOld.intValue() == BackupState.preparingForBackup.intValue() || bsOld
                    .intValue() == BackupState.preparingForRestore.intValue())
            ...
            try {
                ...
                if (accessMethod.isa(StreamAccess.class)) {
                    ...
                    final SequenceOf<OctetString> result = fileAccess.readRecords(start, recordAccess
                            .getRequestedRecordCount().longValue());
