...
public class ReadRangeAck extends AcknowledgementService {
    ...
    public String toString() {
        return "ReadRangeAck [objectIdentifier=" + objectIdentifier + ", propertyIdentifier=" + propertyIdentifier + ", propertyArrayIndex=" + propertyArrayIndex + ", resultFlags=" + resultFlags + ", itemCount=" + itemCount + ", itemData=" + itemData + ", firstSequenceNumber=" + firstSequenceNumber + "]";
    }
