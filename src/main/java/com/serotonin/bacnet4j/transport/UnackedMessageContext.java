...
public class UnackedMessageContext {
    ...
    public String toString() {
        return "UnackedMessageContext [deadline=" + deadline + ", attemptsLeft=" + attemptsLeft + ", clock=" + clock + ", service=" + service + ", consumer=" + consumer + ", originalApdu=" + originalApdu + ", segmentWindow=" + segmentWindow + ", segmentedMessage=" + segmentedMessage + ", segmentTemplate=" + segmentTemplate + ", serviceData=" + serviceData + ", segBuf=" + Arrays
