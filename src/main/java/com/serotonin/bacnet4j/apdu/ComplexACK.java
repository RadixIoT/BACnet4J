...
public class ComplexACK extends AckAPDU implements Segmentable {
    ...
    public ComplexACK(final boolean segmentedMessage, final boolean moreFollows, final byte originalInvokeId,
        ...
        setFields(segmentedMessage, moreFollows, originalInvokeId, sequenceNumber, proposedWindowSize, service
                .getChoiceId());
    ...
    public String toString() {
        return "ComplexACK [segmentedMessage=" + segmentedMessage + ", moreFollows=" + moreFollows + ", sequenceNumber=" + sequenceNumber + ", proposedWindowSize=" + proposedWindowSize + ", service=" + service + ", serviceData=" + serviceData + ", serviceChoice=" + serviceChoice + ", originalInvokeId=" + originalInvokeId + "]";
    }
