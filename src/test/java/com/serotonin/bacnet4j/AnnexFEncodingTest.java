...
public class AnnexFEncodingTest {
    ...
    public void e1_4aTest() {
        ConfirmedEventNotificationRequest confirmedEventNotificationRequest =
    ...
    public void e1_4cTest() {
        AcknowledgeAlarmRequest req = new AcknowledgeAlarmRequest(new UnsignedInteger(1),
                new ObjectIdentifier(ObjectType.analogInput, 2), EventState.highLimit,
    ...
    public void e1_4dTest() {
        SimpleACK pdu = new SimpleACK((byte) 7, 0);
        compare(pdu, "200700");
    }

    @Test
    public void e1_5Test() {
        UnconfirmedEventNotificationRequest unconfirmedEventNotificationRequest =
    ...
    public void e1_8aTest() {
        GetEventInformationRequest getEventInformation = new GetEventInformationRequest(null);
    ...
    public void e1_9aTest() {
        LifeSafetyOperationRequest lifeSafetyOperationRequest = new LifeSafetyOperationRequest(
    ...
    public void e1_12aTest() {
        SubscribeCOVPropertyMultipleRequest req = new SubscribeCOVPropertyMultipleRequest(new Unsigned32(18),
                Boolean.TRUE,
                new UnsignedInteger(
                        60),
    ...
    public void e1_12bTest() {
        SimpleACK pdu = new SimpleACK((byte) 15, 30);
        compare(pdu, "200f1e");
    }

    @Test
    public void e1_13aTest() {
        ConfirmedCovNotificationMultipleRequest req = new ConfirmedCovNotificationMultipleRequest(
    ...
    public void e1_13bTest() {
        SimpleACK pdu = new SimpleACK((byte) 15, 31);
        compare(pdu, "200f1f");
    }
    ...
    public void e1_14aTest() {
        ...
        UnconfirmedRequest pdu = new UnconfirmedRequest(req);
    ...
    public void e2_1aTest() {
        ConfirmedRequestService service = new AtomicReadFileRequest(new ObjectIdentifier(ObjectType.file, 1),
    ...
    public void e2_1bTest() {
        AcknowledgementService service = new AtomicReadFileAck(Boolean.FALSE,
    ...
    public void e2_1cTest() {
        ConfirmedRequestService service = new AtomicReadFileRequest(new ObjectIdentifier(ObjectType.file, 2),
    ...
    public void e2_1dTest() {
        ...
        AcknowledgementService service = new AtomicReadFileAck(Boolean.TRUE,
    ...
    public void e3_4dTest() {
        BaseError baseError = new ErrorClassAndCode(ErrorClass.object, ErrorCode.objectDeletionNotPermitted);
        APDU pdu = new com.serotonin.bacnet4j.apdu.Error((byte) 88, 11, baseError);
    ...
    public void e3_5aTest() {
        ...
        APDU pdu = new ConfirmedRequest(false, false, false, MaxSegments.UNSPECIFIED, MaxApduLength.UP_TO_50,
                (byte) 1, (byte) 0, 0, service);
    ...
    public void e3_9aTest() {
        ConfirmedRequestService service = new WritePropertyRequest(
    ...
    public void e3_11Test() {
        WriteGroupRequest req = new WriteGroupRequest(new Unsigned32(23), new UnsignedInteger(8),
                new SequenceOf<>(
    ...
    public void e4_1aTest() {
        // Example E.4.1 per addendum 135-2016bi-2: Enable-Disable = DISABLE_INITIATION (value 2).
        // Prior to bi-2 the example used DISABLE (value 1); the on-wire enum byte changes from
        // 0x01 to 0x02.
        ConfirmedRequestService service = new DeviceCommunicationControlRequest(new Unsigned16(5),
        ...
        compare(pdu, "00040511090519022D080023656762646621");
    }
    ...
    public void e4_2aTest() {
        EncodedValue parameters = new EncodedValue(new Real(72.4f), new OctetString(new byte[] {0x16, 0x49}));
    ...
    public void e4_5aTest() {
        ConfirmedRequestService service = new ConfirmedTextMessageRequest(
    ...
    public void e5_dTest() {
        AcknowledgementService service = new VtDataAck(Boolean.TRUE, null);
    ...
    private void compare(APDU pdu, String expectedHex) {
