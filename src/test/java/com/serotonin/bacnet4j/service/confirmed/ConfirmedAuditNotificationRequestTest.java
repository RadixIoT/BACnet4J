...
public class ConfirmedAuditNotificationRequestTest {
    @Test
    public void roundTrip() throws BACnetException {
        ...
        ConfirmedAuditNotificationRequest req = new ConfirmedAuditNotificationRequest(new SequenceOf<>(n));

        ByteQueue queue = new ByteQueue();
        req.write(queue);

        assertEquals(req, new ConfirmedAuditNotificationRequest(queue));
    }
}
