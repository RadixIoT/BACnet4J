...
public class ReinitializeDeviceRequestTest extends AbstractTest {
    ...
    public void badPassword() throws Exception {
        ...
        try {
            d1.send(rd2, new ReinitializeDeviceRequest(ReinitializedStateOfDevice.abortRestore, new CharacterString(
                    "wrongPassword"))).get();
    ...
    public void password() throws Exception {
        ...
        d1.send(rd2, new ReinitializeDeviceRequest(ReinitializedStateOfDevice.activateChanges, new CharacterString(
                "testPassword"))).get();
