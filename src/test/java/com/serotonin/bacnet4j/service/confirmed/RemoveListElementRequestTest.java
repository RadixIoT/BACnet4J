...
public class RemoveListElementRequestTest {
    ...
    public void before() throws Exception {
        ...
        localDevice.writePropertyInternal(PropertyIdentifier.vtClassesSupported, new SequenceOf<>(
                VtClass.defaultTerminal, VtClass.ansi_x3_64, VtClass.dec_vt52, VtClass.dec_vt100, VtClass.dec_vt220,
                VtClass.hp_700_94, VtClass.ibm_3130));
        // Create an array of lists.
        localDevice.writePropertyInternal(PropertyIdentifier.forId(5555), new BACnetArray<>( //
