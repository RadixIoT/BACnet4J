 ...
 * ============================================================================
 *
 * Copyright (C) 2019 Radix IoT LLC. All rights reserved.
 *
 ...
 * data type.
 * 
 * It was found that in the previous version of BACnet4J that we could read invalid values without failing. This test is
 * just to show that it no longer works.
 * 
 * @author Terry Packer
 *
 */
