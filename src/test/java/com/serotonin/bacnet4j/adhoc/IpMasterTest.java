...
public class IpMasterTest {
    ...
    public LocalDevice createIpLocalDevice() throws Exception {
        Network network = network = new IpNetworkBuilder().withLocalBindAddress("0.0.0.0").withBroadcast(
                "255.255.255.255", 24).withPort(47808).withLocalNetworkNumber(5).withReuseAddress(true).build();
        ...
        localDevice.getDeviceObject().writePropertyInternal(PropertyIdentifier.modelName, new CharacterString(
                "BACnet4J"));
