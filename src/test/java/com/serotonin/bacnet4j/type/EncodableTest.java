...
public class EncodableTest {
    ...
    public void _20_2_9() throws BACnetException {
        decodePrimitive("751900546869732069732061204241436E657420737472696E6721", new CharacterString(
    ...
    public void _20_2_15() throws BACnetException {
        ...
        decodePrimitive("5D1900546869732069732061204241436E657420737472696E6721", 5, new CharacterString(
                "This is a BACnet string!"));
        decodePrimitive("FD7F1900546869732069732061204241436E657420737472696E6721", 127, new CharacterString(
                "This is a BACnet string!"));
    ...
    public void calendarEntry() throws BACnetException {
        final CalendarEntry ce = new CalendarEntry(new DateRange(new Date(2017, Month.JANUARY, 19, null), new Date(2017,
                Month.JANUARY, 23, null)));
        final ByteQueue queue = new ByteQueue();
    ...
    public void timerStateChangeValue() throws BACnetException {
        ...
        testTimerStateChangeValue(new TimerStateChangeValue(new OctetString(new byte[] {1, 2, 5, 11, 56, (byte) 213})),
                16, "fe1065060102050b38d5ff10");
        ...
        testTimerStateChangeValue(new TimerStateChangeValue(new DateTime(new Date(2017, Month.FEBRUARY, 22,
                DayOfWeek.WEDNESDAY), new Time(13, 4, 20, 68))), 200, "fec82ea475021603b40d0414442fffc8");
        testTimerStateChangeValue(new TimerStateChangeValue(new LightingCommand(LightingOperation.stepUp, new Real(110),
                new Real(5), new Real(1), new UnsignedInteger(60), new UnsignedInteger(8))), 254,
                "fefe3e09031c42dc00002c40a000003c3f800000493c59083ffffe");
    }
