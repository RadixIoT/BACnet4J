...
public class FaultParameterTest {
    ...
    public void extended() throws BACnetException {
        final FaultParameter faultParameter = new FaultParameter(new FaultExtended(new Unsigned16(236),
                new UnsignedInteger(314), new SequenceOf<>( //
                        ...
                        new FaultExtendedParameter(new DeviceObjectPropertyReference(new ObjectIdentifier(
                                ObjectType.largeAnalogValue, 13), PropertyIdentifier.description, null,
                                new ObjectIdentifier(ObjectType.device, 1234))))));
    ...
    public void lifeSafety() throws BACnetException {
        final FaultParameter faultParameter = new FaultParameter(new FaultLifeSafety(new SequenceOf<>( //
    ...
    public void statusFlags() throws BACnetException {
        final FaultParameter faultParameter = new FaultParameter(new FaultStatusFlags(new DeviceObjectPropertyReference(
                new ObjectIdentifier(ObjectType.largeAnalogValue, 13), PropertyIdentifier.description, null,
                new ObjectIdentifier(ObjectType.device, 1234))));
