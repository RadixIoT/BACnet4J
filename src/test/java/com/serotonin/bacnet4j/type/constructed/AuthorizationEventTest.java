...
public class AuthorizationEventTest {
    private static DateTime ts() {
        return new DateTime(new Date(2026, Month.JUNE, 12, DayOfWeek.FRIDAY), new Time(11, 0, 0, 0));
    }
    ...
    public void allFields() throws BACnetException {
        final AuthorizationEvent e = new AuthorizationEvent(
                ts(),
        ...
        assertEquals(e, new AuthorizationEvent(queue));
    }
