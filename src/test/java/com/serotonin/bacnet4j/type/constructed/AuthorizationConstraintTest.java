...
public class AuthorizationConstraintTest {
    @Test
    public void roundTrip() throws BACnetException {
        final AuthorizationConstraint c = new AuthorizationConstraint(Origin.sameNetwork, Authentication.certified);

        final ByteQueue queue = new ByteQueue();
        c.write(queue);

        assertEquals(c, new AuthorizationConstraint(queue));
    }
}
