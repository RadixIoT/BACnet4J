...
public class DateRangeTest {
    ...
    public void specificMatchTest() {
        final DateRange spec = new DateRange(new Date(2014, Month.NOVEMBER, 13, null), new Date(2015, Month.MARCH, 2,
                null));
        test(spec, (gc) -> {
    ...
    public void monthMatchTest() {
        final DateRange spec = new DateRange(new Date(-1, Month.NOVEMBER, -1, null), new Date(-1, Month.FEBRUARY, -1,
                null));
        test(spec, (gc) -> {
            final int month = gc.get(Calendar.MONTH);
            return month == Calendar.NOVEMBER || month == Calendar.DECEMBER || month == Calendar.JANUARY || month == Calendar.FEBRUARY;
        });
    }

    @Test
    public void oneDayMatchTest() {
        final DateRange spec = new DateRange(new Date(2016, Month.NOVEMBER, 4, null), new Date(2016, Month.NOVEMBER, 4,
                null));
        test(spec, (gc) -> {
            final int year = gc.get(Calendar.YEAR);
            final int month = gc.get(Calendar.MONTH);
